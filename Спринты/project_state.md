...
>
> Последнее обновление: 2026-07-29 (**closeout S8R завершён: PR #10 полностью зелёный, backend job в CI снова работает — тесты не выполнялись ~3 недели; E2E-набор идёт одним прогоном**. Первый реальный прогон CI вскрыл и закрыл три дефекта, включая гонку в WS-хендлере, вешавшую весь набор. Плюс закрыт `S8R-ALEMBIC-FRESH-DB-DRIFT` — чистая установка отдавала 500 на входе. ТЗ → v1.8.)
>
