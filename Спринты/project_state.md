...
>
> Последнее обновление: 2026-07-27 (**дозакрытие S8.8 + синхронизация ФТ/ТЗ**. Визуальная проверка заказчика завернула пункт «Изменение формы» — найдены и исправлены BUG-33/BUG-34; фиксы приёмки собраны в PR #9. ФТ → v2.8, ТЗ → v1.6. Следующий шаг — старт Sprint 9 «Перевод в продуктив».)
>
