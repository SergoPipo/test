...
ТЕКУЩЕЕ ДЕЙСТВИЕ (2026-07-27): Gate Sprint_8_Review ПРОЙДЕН — PASS WITH NOTES.
  Дозакрыт последний пункт чеклиста S8.8 (BUG-33/BUG-34 — фигуры разметки исчезали
  с графика). Непокрытых пунктов приёмки не осталось. ФТ v2.8 / ТЗ v1.6 синхронизированы.
  ...
  «реальная сделка → 3 канала» в торговые часы, S9-backlog косметики (8 карточек),
