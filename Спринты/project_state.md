...
```
ТЕКУЩЕЕ ДЕЙСТВИЕ (2026-09-24): цикл фиксов аудита — ИДЁТ, пакет BLOCKER
  ...
  ПАКЕТ HIGH — ИДЁТ (ветка s8r/fix-high стеком от s8r/fix-blocker):
    034, 035 (миграция c5e8b2a7f913), 036 закоммичены во worktree B,
    093 — на гейте. ВОПРОС ЗАКАЗЧИКУ (093): торги выходного дня MOEX
