...
- [ ] Бумажный режим не ограничен: две paper-сессии по одному тикеру запускаются как раньше.
...
| S8.30 Один инструмент — одна сессия на счёте | 10 | S8R-DUPLICATE-SESSION-PER-INSTRUMENT, S8R-RECONCILE-NO-ACCOUNT-DEDUP |
| **Итого S8 (новых пунктов)** | **220** | |
