...
- [ ] Вторая сессия на том же брокерском счёте не останавливает первую: обе продолжают торговать, хотя у брокера бумаг больше, чем знает каждая по отдельности.
